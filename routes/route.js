...
router.post('/api/v1/parcels', parcelController.createParcels, validator.parcelValidator,);
...
router.post('/api/v1/users/register', userController.addUser, validator.userValidator);
